...
import { createCattleListing } from "@/app/actions/cattle";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-50 via-white to-earth-50">
      ...
      <main className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-ink-900 sm:text-3xl">List your cattle</h1>
        ...
        {state?.success ? (
          <div className="rounded-3xl border border-brand-100 bg-white p-8 text-center shadow-sm">
            ...
            <h2 className="mt-4 text-xl font-semibold text-ink-900">Listing published!</h2>
            <p className="mt-1 text-sm text-slate-500">Redirecting you to the homepage...</p>
          </div>
        ) : (
